...
const Tutorial = ({ match }) => {
  ...
  const handleChangeInformation = (event) => {
    ...
    if(name === "netIncome" || name === "overspentLastMonth" || name === "netMinusOverspent") {
  ...
  const changeNbDebtSaving = (event) => {
    ...
    if(elemType === "nbDebts" || elemType === "nbSavings" || elemType === "nbCategories") {
        ...
        <Row>
            ...
            <table className="table-tutorial overview">
              <tbody>
                ...
                <tr>
                  ...
                  <td className="right-col"><ClassicInput type="text" name="overspentLastMonth" id="overspentLastMonth" onChange={handleChangeInformation} value={accountInformation.overspentLastMonth} /></td>
                </tr>
                <tr>
                  <td className="left-col">Net Income minus overspent</td>
                  <td className="right-col"><ClassicInput type="text" name="netMinusOverspent" id="netMinusOverspent" onChange={handleChangeInformation} value={accountInformation.netIncome - accountInformation.overspentLastMonth} /></td>
                </tr>
                <tr className="separator">
                  <td className="left-col title">DEBTS</td>
                  <td className="right-col">
                    <div className="debt-control plus" data-type="nbDebts" onClick={changeNbDebtSaving}>+</div>
                    <div className="debt-control minus" data-type="nbDebts" onClick={changeNbDebtSaving}>-</div>
                  </td>
                </tr>
                {
                ...
                <tr className="separator">
                  ...
                  <td className="right-col">
                    <div className="debt-control plus" data-type="nbSavings" onClick={changeNbDebtSaving}>+</div>
                    <div className="debt-control minus" data-type="nbSavings" onClick={changeNbDebtSaving}>-</div>
                  </td>
                </tr>
                {
          ...
          <Col xs={12} md={6} className={`step-2 ${currentStep === 2 ? '' : 'd-none'}`}>
            ...
            <table className="table-tutorial distribute">
              <tbody>
                <tr className="separator">
                <td className="left-col title">BUDGET CATEGORIES <br /><span className={`amount-left ${total < 0 ? 'warning' : ''}`}>Amount left: {total}</span></td>
                  <td className="right-col">
                    <div className="budget-control plus" data-type="nbCategories" onClick={changeNbDebtSaving}>+</div>
                    <div className="budget-control minus" data-type="nbCategories" onClick={changeNbDebtSaving}>-</div>
                  </td>
                </tr>
                {
          ...
          <Col xs={12} md={6} className={`step-3 ${currentStep === 3 ? '' : 'd-none'}`}>
            ...
            <div className="button-group">
              <ClassicButton onClick={previousStep} className="classic-button previous-button">Previous</ClassicButton>
              <ClassicButton onClick={buildTheCategories} className="classic-button test-button">Test</ClassicButton>
